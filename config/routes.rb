...
Rails.application.routes.draw do
  ...
  get    "checkout/fast/choose_ship_to_address" => "checkout#fast_choose_ship_to_address"
  get    "checkout/fast/choose_bill_to_address" => "checkout#fast_choose_bill_to_address"
  get    "checkout/fast/choose_shipping_method"  => "checkout#fast_choose_shipping_method"
  get    "checkout/fast/new_address" => "checkout#fast_new_address"
  patch  "checkout/fast/update_ship_to_address" => "checkout#fast_update_ship_to_address"
  get    "checkout/fast/update_ship_to_address" => "checkout#fast_update_ship_to_address"
  patch  "checkout/fast/update_bill_to_address" => "checkout#fast_update_bill_to_address"
  get    "checkout/fast/update_bill_to_address" => "checkout#fast_update_bill_to_address"
  patch  "checkout/fast/update_shipping_method" => "checkout#fast_update_shipping_method"
  get    "checkout/fast/update_shipping_method" => "checkout#fast_update_shipping_method"
